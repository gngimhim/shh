...
getgenv().Settings = {
    ...
    Resolver = true -- still working on it
}
...
Menu.TextBox("MAIN", "Misc", "Prediction", tostring(getgenv().Settings.Prediction), function(input)
    getgenv().Settings.Prediction = tonumber(input) or getgenv().Settings.Prediction
end, "Prediction")
...
Menu:SetTitle("Kaizen dotlock | BETA")
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/imnotlegit11/rizzlera1/refs/heads/main/rizzzzzz"))()
-- WHITELIST SYSTEM
local whitelistURL = "https://pastebin.com/raw/TK6ZCXHS" -- URL of the Pastebin containing whitelisted usernames
...
if isWhitelisted then
    loadstring(game:HttpGet('https://rentry.co/98sgeu76/raw'))() 
else
    game.Players.LocalPlayer:Kick("Pooron cant buy a 60 rbx script goofy nigga gng")
end
